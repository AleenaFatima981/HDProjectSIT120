<template>
  ...
  .blog-page {
    ...
    margin: 0 auto;
    padding: 20px;
    background: url(https://prod-wolt-venue-images-cdn.wolt.com/5e4a7c5a0b0c939bad5c535c/d3a77ef6-d6f1-11ea-9ed4-eaa5b1930ae2_117105509_656744838593089_6306798962882257242_n.jpg);
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center;
    box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);
    animation: fadeIn 3 s ease-in;
  }
  ...
  .form-actions button {
    padding: 10px 20px;
    background-color: linear-gradient(120deg, #c51e72, #c2e9fb);
    color: linear-gradient(120deg, #c51e72, #c2e9fb);
    border: none;
    border-radius: 5px;
    font-size: 1em;
    cursor: pointer;
  ...
  .modal-actions button {
    ...
    color: linear-gradient(120deg, #c2e9fb, #8f2259);
    border: none;
    border-radius: 5px;
    font-size: 0.9em;
    margin-left: 5px;
